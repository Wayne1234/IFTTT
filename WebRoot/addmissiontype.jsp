...
%>
<%
String mythis=request.getParameter("this");
String mythat=request.getParameter("that");
System.out.println(mythis);
System.out.println(mythat);
String type=request.getParameter("toall");
if(mythis.equals("1")&& mythat.equals("1")){
	type="type1";
}else if(mythis.equals("1")&& mythat.equals("2")){
type="type2";
}else if(mythis.equals("2")&& mythat.equals("1")){
type="type3";
}else type="type4";
%>
...
<form action="doaddmission.jsp" method="get">
<p>taskname:<input type="text" name="taskname" /></p><br>
...
<%
	...
	%>
  <p>receiveemail: <input type="text" name="rcemail" /></p>
  <p>password: <input type="password" name="rcpassword" /></p>
<p>sendemail: <input type="text" name="sendemail" /></p>
  <p>index: <input type="text" name="mailindex" /></p>
<br>
<br>
...
<p>sendemail: <input type="text" name="sendemail" align="absleft" /></p>
  <p>password : <input type="password" name="sendpassword" align="absleft" /></p>
  <p>index   :  <input type="text" name="mailindex" /></p>
  <%

}
if(type.equals("type2")||type.equals("type4")){%>
	<p>weiboaccount: <input type="text" name="weiboaccount" align="absleft" /></p>
  <p>password: <input type="password" name="weibopassword" align="absleft"/></p>
		<p>index:     <input type="text" name="weiboindex" align="absleft"/></p>
		<%
}
if(type.equals("type1"))
{
%>
<p>toemail: <input type="text" name="toemail" /></p>
<%
}%>
	<br>
