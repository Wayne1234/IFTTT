...
if(deletet!=null){
statement.executeUpdate("delete from task where user='"+user+"'&& taskid='"+deletet+"'");
%>
<script>alert("delete message success");self.location='deleterecipe.jsp';
</script>
<%
}

rs = statement.executeQuery("select * from task where user = '"+Calvin+"'");
rs.last(); 
...
<%if(c.equals("type1"))
  ...
  if(c.equals("type3"))
	...
	}%><a href="deleterecipe.jsp?delete=<%=b%>"><font color="purple" valign="right">[delete]</font></a>
