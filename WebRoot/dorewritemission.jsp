...
String taskid=request.getParameter("select");
String type="1";
int money1=0;
int lv=0;
...
rs = statement.executeQuery("select * from task where taskid = '"+taskid+"'");
while(rs.next()){
type=rs.getString(4);
System.out.println(type);
} 
%>
<form action="rewrite.jsp" method="get">
...
<p>sendemail: <input type="text" name="sendemail" /></p>
  <p>password: <input type="password" name="sendpassword" /></p>
  <p>index: <input type="text" name="mailindex" /></p>
  <%

}
if(type.equals("type2")||type.equals("type4")){%>
	<p>weiboaccount: <input type="text" name="weiboaccount" /></p>
  <p>password: <input type="password" name="weibopassword" /></p>
		<p>index: <input type="text" name="weiboindex" /></p>
		<%
}
if(type.equals("type1"))
{
