...
<form action="changemoney.jsp" method="post" accept-charset="UTF-8"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="FCon40ITFH0t5xvT6aPTAbCM5YVYAD6v/jxfLqm5sLs="></div>
<div class="form_unit">
<label class="mop_label" for="login">How much to recharge?</label>
<input name="money" class="form_text mop_input" id="login" autofocus="autofocus" type="text"  autocorrect="off" autocapitalize="off">
</div>
<div class="form_unit">
<input name="commit" class="btn-primary" type="submit" value="$Recharge$" data-disable-with="RECHARGING...">
</div>
